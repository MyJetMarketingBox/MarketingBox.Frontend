...
import { clearCampaigns, deleteCampaign, getCampaigns } from "../../store/campaigns/actions";
                  ...
                  <TabPane tabId={TabsEnum.Campaign}>
                    ...
                    <Row>
                      {campaigns.map((campaign: any) => (
                        <MiniCard data={campaign} path={`/campaigns/${campaign.id}`} handleDelete={handleDeleteCampaign} key={campaign.id}/>
                      ))}
                    </Row>
