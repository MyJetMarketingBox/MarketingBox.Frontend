...
import { clearPostback, getPostback, updatePostback, delPostback } from "../../store/postback/actions";
import {
  Button,
  Card,
  CardBody,
...
const Postback: React.FC = () => {
  ...
  const {postback, loaded, loading, upLoading, upLoaded} = useSelector((state:any ) => {
    return {
  ...
  return (
    <React.Fragment>
              ...
              <Card>
                ...
                <AvForm className="needs-validation" onValidSubmit={(
                  ...
                  <CardFooter>
                    ...
                    <Button className="btn custom-btn-light" type="submit" onClick={popupDeleteConfirmOpen}>
                      Delete
                    </Button>
                  </CardFooter>
                </AvForm>
      ...
      {
        isDeleteConfirm && <ConfirmDelete close={popupDeleteConfirmClose} handleDelete={handleDeletePostback()}/>
      }
    </React.Fragment>
  )
