...
export default (props: any) => {
  ...
  const { theme, affiliates, loadingAffList, countries, loadingCountries, brands, loadingBrandList,integrations, loadingIntegrList, campaigns, loadingCampaigns, loadingRegistration } = useSelector((state: any) => {
    return {
      ...
      <Col className="col-md-4 offset-4 text-end">
        ...
        >
          {collapse ? (
            <>
              Hide filters
              {(countFilter > 0) ? <span className="count-white ml-10">{countFilter}</span> : <i className="bx bx-filter me-1 font-size-20 icon" />}
            </>
          ) : (
            <>
              Open filters
          ...
          >
            ...
            <Row>
              ...
              <Col lg={3}>
                ...
                >
                  {loadingRegistration && <i className="bx bx-hourglass bx-spin me-2"/>}
                  Search
                </button>
              </Col>
            </Row>
