...
export default ({setParams}: any) => {
  ...
  }, [selectAff, selectCampaign, selectFrequency, portionLimit, dayLimit, useAutologin, nameRedistribution])
  ...
  const frequencyList = RedistributionFrequency.map((item: any, idx: number) => {
    return {
      value: idx,
      label: item,
    };
        ...
        <Row>
          ...
          <Col lg={3}>
            <AvField
              ...
              type="text"
              validate={{
                required: {value: true, errorMessage: 'Please enter a Portion Limit'},
                pattern: {value: '^[0-9]+$', errorMessage: 'Your name must be composed only numbers'},
                minLength: {value: 1, errorMessage: 'Your name must be between 1 and 100 characters'},
                maxLength: {value: 100, errorMessage: 'Your name must be between 1 and 100 characters'}
              }}
          ...
          <Col lg={3}>
            ...
            <div className="square-switch mt-2">
              <Input type="checkbox" id="square-switch4" switch="my-orange" name="useAutologin" defaultChecked={useAutologin} onChange={handleUseAutologin}/>
